...
const sendChat = () => {
  ...
  const userName = userSession.value ? userSession.value.name : "Saya";
...
<template>
  <div class="bg-gradient-to-b from-gray-900 to-gray-800 flex flex-col rounded-b-xl h-[600px] lg:sticky lg:top-24 shadow-2xl">
    ...
    <div
      ref="chatContainer"
      class="flex-grow overflow-y-auto p-4 space-y-3 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent"
    >
      ...
      <div
        v-if="!isLoggedIn"
        class="mt-8 p-6 bg-gray-800/80 backdrop-blur-sm rounded-lg border border-gray-600 text-center"
      >
