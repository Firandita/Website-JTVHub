...
const ongoingEvents = [
  {
    ...
    poster: {
      image: "HACKATON.jpeg",
      title: "Hackathon Kuadran 4.0",
      description: "Detail poster Hackathon...",
    },
  },
  {
    id: 2,
    ...
    poster: {
      image:
        "https://via.placeholder.com/600x400/33FF57/FFFFFF?text=Musik+Lokal+Poster",
      title: "Event Komunitas",
      description: "Saksikan penampilan band terbaik.",
    },
  },
  {
    id: 3,
    ...
    poster: {
      image:
        "https://via.placeholder.com/600x400/3357FF/FFFFFF?text=Seminar+IoT+Poster",
      title: "Seminar Nasional IoT",
      description: "Membahas tren terbaru IoT.",
    },
  },
  {
    id: 4,
    ...
    poster: {
      image:
        "https://via.placeholder.com/600x400/FFFF33/000000?text=Voliga+Poster",
      title: "Voliga Jatim Cup",
      description: "Kejuaraan bola voli se-Jatim.",
    },
  },
];
</script>
...
<template>
  ...
  <section class="container mx-auto px-4 md:px-16 py-10">
    ...
    >
      Ikuti Dan Ramaikan
      <span class="text-orange-600"> Keseruan <br />Event </span>Kami!
    </h2>
    ...
    >
      <router-link to="/event">
        <button
          class="px-8 py-3 bg-orange-600 hover:bg-orange-700 text-white font-medium rounded-full shadow-lg transform transition-all duration-300 hover:-translate-y-1"
        >
  ...
  >
    <div
      class="bg-gray-900 rounded-lg p-6 max-w-lg w-full relative border border-gray-700 max-h-[90vh] overflow-y-auto"
    >
      <button
